                ...
                <DrawerContent p={-2}>
                    <DrawerHeader>
                        <Box w={'100%'} h={'50px'} display={'flex'} flexDir={'row'}
                            ...
                            <Box w={'15px'} h={'15px'} bgColor={'pink'} m={'15px !important'}></Box>
                    ...
                    <DrawerFooter display={'flex'} flexDir={'column'} alignItems={'flex-start'}>
                        ...
                        <Box mt={'30px !important'} alignItems={'center'} width={'100%'} display={'flex'} flexDir={'row'}>
                            ...
                            <Text ml={'15px !important'} fontFamily={'Haffer-Regular'} fontSize={'12px'} w={'70%'} >Advanced Feedback</Text>
                        </Box>
                        <HStack mt={'30px !important'} alignItems={'center'} w={'100%'} >
                            ...
                            <Text ml={'15px !important'} fontFamily={'Haffer-Regular'} fontSize={'12px'} w={'70%'} >Log out</Text>
                        </HStack>
